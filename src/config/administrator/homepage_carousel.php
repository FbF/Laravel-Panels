...
return array(
	...
	'query_filter'=> function($query)
		{
			$query->where('type','=','HOMEPAGE_CAROUSEL');
		},
	...
	'edit_fields' => array(
		...
		'css_class' => array(
			'title' => 'CSS Class',
			'type' => 'enum',
			'options' => Config::get('laravel-panels::types.HOMEPAGE_CAROUSEL.css_class.options'),
			'visible' => Config::get('laravel-panels::types.HOMEPAGE_CAROUSEL.css_class.show'),
		),
		'image_1' => array(
			'title' => 'Background Image',
			'type' => 'image',
			'naming' => 'random',
			'location' => public_path(Config::get('laravel-panels::types.HOMEPAGE_CAROUSEL.images.image_1.original.dir')),
			'size_limit' => 5,
			'sizes' => array(
				array(
					Config::get('laravel-panels::types.HOMEPAGE_CAROUSEL.images.image_1.sizes.resized.width'),
					Config::get('laravel-panels::types.HOMEPAGE_CAROUSEL.images.image_1.sizes.resized.height'),
					'crop',
					public_path(Config::get('laravel-panels::types.HOMEPAGE_CAROUSEL.images.image_1.sizes.resized.dir')),
					100
				),
			),
		),
		'image_2' => array(
			...
			'type' => 'image',
			'naming' => 'random',
			'location' => public_path(Config::get('laravel-panels::types.HOMEPAGE_CAROUSEL.images.image_2.original.dir')),
			'size_limit' => 5,
			'sizes' => array(
				array(
					Config::get('laravel-panels::types.HOMEPAGE_CAROUSEL.images.image_2.sizes.resized.width'),
					Config::get('laravel-panels::types.HOMEPAGE_CAROUSEL.images.image_2.sizes.resized.height'),
					'crop',
					public_path(Config::get('laravel-panels::types.HOMEPAGE_CAROUSEL.images.image_2.sizes.resized.dir')),
					100
				),
			),
			'visible' => Config::get('laravel-panels::types.HOMEPAGE_CAROUSEL.images.image_2.show'),
		),
		'status' => array(
			'type' => 'enum',
			'title' => 'Status',
